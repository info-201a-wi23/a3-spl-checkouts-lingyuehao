...
This dataset provides valuable information, including the most recent data available up to January 2023. During the period from 2017 to January 2023, the average number of checkouts for an eBook from the Seattle Public Library was 25.1, while for books it was 20.9. One particularly popular book during this time period in both the eBook and book categories at the Seattle Public Library was "Educated: A memoir" by Tara Westover. This suggests that the book has been highly sought after by library patrons in Seattle in recent years. Furthermore, the total number of eBooks checked out by the Seattle Public Library in the years 2018-2021 were 24,328, 30,653, 41,944, and 41,761, respectively.
...
The parameters of this dataset include the type of item (digital, physical, etc.), the type of checkouts (OverDrive, Horizon, etc.), the type pf material (e-book, magazine, etc.), the number of checkouts, the date (including year and month) of checkouts, the title of the checkout items (physical or electronic), and the creator of the items (physical or electronic).
